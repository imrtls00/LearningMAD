...
export default function ColorScreen() {
    ...
    const [position, setPosition] = useState(['center', 'flex-start', 'flex-end'])
    ...
    return (
        <View>
            ...
            <FlatList data={colors} renderItem={({item})=>{
                return <View style={{ height: heightWidthRandomize(), width: heightWidthRandomize(), backgroundColor: item, alignSelf:randomPosition()}}></View>
            }}/>
